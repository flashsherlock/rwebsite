---
title: Use gdata package to read xls files
author: Fei
date: '2020-05-06'
categories:
  - R
...
library(gdata)
load("../../static/post/2020-05-05-read-xls-files_files/course_time.RData")
```
...
I have stored the data in the [.RData](/post/2020-05-05-read-xls-files_files/course_time.RData) file (you can click the link to download it), because the local files can not be accessed when Netlify build the website.
```{r}
library(DT)
