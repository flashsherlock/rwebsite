...
I have stored the data in the [.RData](/post/course_time.RData) file (you can click the link to download it), because the local files can not be accessed when Netlify build the website.
```{r}
